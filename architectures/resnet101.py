...
class ResNet101_Backbone(nn.Module):
    """
    Pretrained ResNet-101 adapted for grayscale input 
    ...
    def __init__(self, embed_dim=256, freeze_until='layer3', dropout=0.1, finetune_input=True):
        super().__init__()
        base = tvm.resnet101(weights=tvm.ResNet101_Weights.DEFAULT)
        ...
        self.proj = nn.Sequential(
            nn.Linear(2048, embed_dim),  # ResNet-101 also has 2048 output features
